...
| fillscreen | Fills the background with (color, shade) | It has a numerical block attached where you must indicate the numeric value for the color (by default: 60) and shade (by default: 80). Reset turtle location to (0,0). |
