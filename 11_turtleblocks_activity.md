...
1. Activity toolbar (Project toolbar):
   ![activity](images/11_screen_1.png)
   1. Project Title
   2. Share button
   3. Save copy<br><br>

2. Edit Toolbar:
   ![edit](images/11_screen_2.png)
   1. Copy
   2. Paste<br><br>

3. Save Toolbar:
   ![save](images/11_screen_3.png)
   1. Instant save
   2. Save as HTML
   3. Save as LOGO
   4. Save as Image
   ...
   6. Load Python block
   7. Load examples<br><br>

4. View Toolbar:
   ![view](images/11_screen_4.png)
   1. Fullscreen
...
6. Help toolbar
   ...
   Enables contextual help<br><br>

7. ![clean](images/11_screen_7.png) CLEAN: Clean drawing in the canvas<br>
8. ![run](images/11_screen_8.png) RUN: Runs the program (*Start* block) (maximum speed)<br>
9. ![step](images/11_screen_9.png) RUN SLOWLY: Runs the program at low speed<br>
10. ![debug](images/11_screen_10.png) DEBUG: Runs the program block by block (to review the programming)<br>
11. ![stop](images/11_screen_11.png) STOP TURTLE: Stops the execution of the program (red: RUN / black: STOP)<br>
12. ![quit](images/11_screen_12.png) STOP: Closes Turtle Blocks Activity<br>

![hide](images/11_screen_13.png) HIDE BLOCKS: in this state, it shows blocks; when fill color is yellow, it hides them. You may toggle between views by clicking this icon found on the right of the "trash bin".

## Palettes

1. Turtle commands palette
   ![turtle commands](images/11_palette_1.png)

2. Pen commands palette
   ![pen commands](images/11_palette_2.png)

3. Pen colors palette
   ![pen colors](images/11_palette_3.png)

4. Numerical operators palette
   ![numerical operators](images/11_palette_4.png)

5. Flow operators palette
   ![flow operators](images/11_palette_5.png)

6. Variable blocks palette
   ![variable blocks](images/11_palette_6.png)

7. Sensor palette
   ![sensor blocks](images/11_palette_7.png)

8. Media object palette
   ![media blocks](images/11_palette_8.png)

9. Additional options palette
   ![additional blocks](images/11_palette_9.png)

10. Presentation templates palette
   ![presentation templates](images/11_palette_10.png)

11. Trash bin
   ![trash bin](images/11_palette_11.png)
...
<img src="images/12_icon_3_python.png" align="left">
Sometimes it may be necessary to execute a chunk of Python code in order to perform a specific task not supported within the TB blocks included in the Turtle Blocks Activity palettes. For this we can proceed in one of the following ways:
...
![pyblock toolbar](images/11_screen_14_w_arrows.png)

![pyblock load](images/11_screen_15.png)
...
|`resistance`| Value of the resistance connected to the microphone: (range 700 to 14000 ohms) | Measures the resistance between TS contacts (tip and sleeve, left stereo channel). The indicated range is only correct for the XO1. <br> Ranges: <br> XO1: 750 Ω to 14 kΩ <br> XO1.5: 2kΩ to 420 MΩ <br> XO1.75 SKU 206: 0 to 1x10^7 Ω
|`resistance2`| Value of the resistance connected to the microphone: (range 700 to 14000 ohms) | Measures the resistance between RS contacts (ring and sleeve, right stereo channel). The indicated range is not correct. <br> Ranges: <br> XO1: 750 Ω to 14 kΩ <br> XO1.5: 2kΩ to 420 MΩ <br> XO1.75 SKU 206: 0 to 1x10^7 Ω
|`voltage`  | DC value of voltage connected to the microphone input (range: 0.40 to 1.90 V) | In case of using a stereo connector (TRS), it measures the voltage between the TS contacts (tip and sleeve), corresponding to the left channel. The indicated range corresponds only with XO1. <br> Ranges: <br> XO1: 0.4 to 1.85 V <br> XO1.5: 0.17 to 3.0 V <br> XO1.75 SKU 206: 0 to 3.03 V |
|`voltage2` | DC value of voltage connected to the microphone input (range: 0.40 to 1.90 V) | In case of using a stereo connector (TRS), it measures the voltage between the RS contacts (ring and sleeve), corresponding to the right stereo channel. The indicated range is incorrect. <br> Ranges: <br> XO1: 0.4 to 1.85 V <br> XO1.5: 0.17 to 3.0 V <br> XO1.75 SKU 206: 0 to 3.03 V |
